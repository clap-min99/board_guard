    ...
    try:
            ...
            # 뭔가 넘어왔음.
                ...
                if _missing_check == 1: #
                    ...
                    # 박스와 같은 프레임의 정보를 보관하고 확정 후에는 유지한다.
                    _l_causes = [list(names) for names in (causes or [])] if _l_state != "PASS" else []
                    _l_defect_types = list(defect_types or []) if _l_state != "PASS" else []
